...
const AdvertisingSpace = () => {
  ...
  const totalPages = Math.ceil(AdvertisingSpaces.length / itemsPerPage);
  const [goTo, setGoTo] = useState("");

  const paginatedCourse = AdvertisingSpaces.slice(
  ...
  return (
    <div className="p-4">
      ...
      <div className="grid text-center grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {paginatedCourse.map((advertisingSpace, index) => (
          <div
            key={index}
